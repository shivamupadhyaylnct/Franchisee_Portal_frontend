...
<<<<<<< HEAD
  ...
  const fetchTabledata = async () => {
    try {
      const response = await axios.get(`${baseURL}${config.getKnowledgeCenterSOPFiles}`);
=======
  ...
  const fetchTabledata = async () => {
    try {
      const response = await apiGet(config.getKnowledgeCenterSOPFiles);
>>>>>>> branch-b
