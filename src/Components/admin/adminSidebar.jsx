                ...
                <nav id="sidebar">
                    ...
                    <div className="navbar-nav theme-brand flex-row  text-center">
                        <div className="nav-logo">
                            ...
                            <div className="nav-item theme-text"> <a href="#" className="nav-link"> Franchise Portal </a> </div>
                        </div>
                    ...
                    <ul className="list-unstyled menu-categories" id="accordionExample">
                        ...
                        <li className={`menu ${location.pathname === "/admin/alert" ? "active" : ""}`}>
                            <Link to="/admin/alert" className="dropdown-toggle">
                                <div className="">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                    <path stroke-dasharray="64" stroke-dashoffset="64" d="M12 3l9 17h-18l9 -17Z">
                                        ...
                                        <animate fill="freeze" attributeName="stroke-dashoffset" begin="0.6s" dur="0.2s" values="6;0"/></path>
                                        <path stroke-dasharray="2" stroke-dashoffset="2" d="M12 17v0.01"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.8s" dur="0.2s" values="2;0"/></path></g>
                                    </svg>                                    
                                    <span>Alert</span>
                                </div>
                            </Link>
                        ...
                        <li className={`menu ${location.pathname === "/admin/franchise" ? "active" : ""}`}>
                            <Link to="/admin/franchise" className="dropdown-toggle">
                                <div className="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="currentColor" d="M22 3H2c-1.09.04-1.96.91-2 2v14c.04 1.09.91 1.96 2 2h20c1.09-.04 1.96-.91 2-2V5a2.074 2.074 0 0 0-2-2m0 16H2V5h20zm-8-2v-1.25c0-1.66-3.34-2.5-5-2.5s-5 .84-5 2.5V17zM9 7a2.5 2.5 0 0 0-2.5 2.5A2.5 2.5 0 0 0 9 12a2.5 2.5 0 0 0 2.5-2.5A2.5 2.5 0 0 0 9 7m5 0v1h6V7zm0 2v1h6V9zm0 2v1h4v-1z" /></svg>                                       
                                    <span>Franchisee Details</span>
                                </div>
                            </Link>
                        </li>
                        <li className={`menu ${location.pathname === "/admin/cmr_ndc_details" ? "active" : ""}`}>
                            <Link to="/admin/cmr_ndc_details" className="dropdown-toggle">
                                <div className="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M3.5 20V3h1v16h16v1zm3.885-3.5V9.192h2V16.5zm4.5 0V4.192h2V16.5zm4.5 0v-3.308h2V16.5z" /></svg>                                      
                                    <span>CMR NDC Details</span>
                                </div>
                            </Link>
                        </li>
